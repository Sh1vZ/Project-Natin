...
<div class='card1 green'>
    <div class='additional'>
      <div class='user-card'>";
                                    ...
                                    echo "
                <a class='link' href='registratie-bestedingen.php?id=$id&idt=$idt'><button class='icon5'  data-role='update' data-id='$idt'><i class='fas fa-eye' data-toggle='tooltip' data-placement='top' title='Meer'></i></button></a>
             ";

                                    if ($_SESSION['role'] == 'Administratie' or $_SESSION['role'] == 'Beheerder') {
                                        echo "
                        <a class='link' href='#'><button class='icon' onclick=EditTaak($idt)><i class='fas fa-edit' data-toggle='tooltip' data-placement='top' title='Bewerken'></i></button></a>
                    ";
                                    }
                                    if ($_SESSION['role'] == 'Beheerder') {
                                        echo "
                        <a class='link' href='#'><button class='icon6' onclick=DeleteTaak($idt)><i class='fas fa-trash-alt' data-toggle='tooltip' data-placement='top' title='Verwijderen'></i></button></a>
                     ";
                                    }
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" title="Kies Richting" data-live-search="true" id="richting" name="richting">
                                                <?php

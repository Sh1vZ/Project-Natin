            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="materialen" id='matedit' placeholder="Voer in..." rows="1" cols="40" required><?= $mat ?></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 mb-2">
                    ...
                    <input class="form-control" type="number" name='aantal' id='aantedit' placeholder='Aantal' in="0" value="<?= $aant ?>" step="0.1">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 mb-2">
                    <label for="pwd">Prijs:</label>
                    <input class="form-control" type="number" name='prijs' id='prijsedit' placeholder='Prijs $' in="0" value="<?= $prijs ?>" step="0.1">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <script>
                            $('#session_pick').selectpicker('val', '<?= $idd ?>');
                        </script>
                    </div>
                </div>
            </div>
        ...
        <form action="" method="" style="width:60vw; margin:0 auto">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="pwd">Prijs:</label>
                        <input class="form-control" type="number" name='prijs' id='prijs1' placeholder='Prijs $' in="0" value="<?= $prijs ?>" step="0.1">
                    </div>
                </div>
            </div>
        </form>

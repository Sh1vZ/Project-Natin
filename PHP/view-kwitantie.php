              ...
              <table id="" class='table table-hover '>
                ...
                <tbody>
                  ...
                  if (mysqli_num_rows($res) > 0) {
                    ...
                    <td>$taaknaam</td>
                    <td>$InlDatum</td>
                    <td><a  href='data:image/jpeg;base64 ," . base64_encode($row["Foto"]) . "' width='70' height='38' target='_blank'><img class='img-thumbnail'  src='data:image/jpeg;base64," . base64_encode($row["Foto"]) . "'  height='200' width='200' /></a></td>
                    </tr>
            ...
            <form action="" id="submit" name="form" method="POST" style="width:60vw; margin:0 auto" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" onclick="submitForm()" name="submitKwitantie" class="btn btn-success">Opslaan</button>
            </form>
          </div>
        </div>
      </div>

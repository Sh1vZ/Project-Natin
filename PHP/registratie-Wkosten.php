                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="date" id="Idatum" class="form-control" name="Idatum" placeholder="Begin Datum" required>
                      </div>
                    </div>
...
>>>>>>> 176579078d994ef1ea89681ad5eb42e8eed381be
    ...
    <div class="container-fluid">
          ...
          <?php
          $id = $_GET["id"];
          $sql = "SELECT * FROM kwitantie WHERE ID=$id";
          $res = mysqli_query($conn, $sql);
          if (mysqli_num_rows($res) > 0) {
            while ($row = mysqli_fetch_assoc($res)) {
              $bestedingen = $row["BestedingenID"];
              $werkelijkbedrag = $row["WerkelijkeBedrag"];
              $ingeleverdd = $row["IngeleverdDatum"];
              $foto = $row['Foto'];
              $status = $row["Status"];
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-gray-900 center"><?php echo 'Kwitantie' ?></h6>
            </div>
            <div class="card-body">
              <?php
              echo "<p class='card-text'>$bestedingen</p>";
              echo "  <table>
 <tr>
 <td>Werkelijke Bedrag: </td>
     <td>$werkelijkbedrag</td>
 </tr>
 <tr>
 <td>Ingeleverd Datum: </td>
    <td>$ingeleverdd</td>
 </tr>
 <tr>
 <td>Status: </td>

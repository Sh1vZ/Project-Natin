...
?>
          <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h3 class="m-0 font-weight-bold text-gray-900 center"><?php echo $Vnaam, $Anaam; ?></h3>
                </div>
                <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="number" id="naam" class="form-control" name="bedrag" placeholder="" required>
                          </div>
                        </div>
                      </div>
                      <div class="row">

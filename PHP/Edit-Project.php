                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id='naam1' class="form-control" name="project-naam" placeholder="Naam" value='<?= $naam; ?>' required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id='datum-begin1' class="form-control" name="datum-begin" placeholder="Begin Datum" value='<?= $begind; ?>' required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                <label for="pwd">Eind Datum:</label>
                                <input type="date" id='datum-eind1' class="form-control" name="datum-eind" placeholder="Begin Datum" value='<?= $eindd; ?>' required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="selectpicker form-control" title="Kies Richting" id='leider1' data-live-search="true" name="project-leider">
                                    <?php
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="omschr1" name="omschrijving" placeholder="Voer in..." rows="3" required><?= $omschr; ?></textarea>
                            </div>
                        </div>
                    </div>
            </div>
